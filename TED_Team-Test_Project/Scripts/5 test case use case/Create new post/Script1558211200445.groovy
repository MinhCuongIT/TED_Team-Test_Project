...
switch (1) {
    case 1:
        WebUI.setText(findTestObject('Object Repository/Page_Spectrum community/input_Info_sc-gzVnrw lbskuL'), 'Case 1')

        break
    case 2:
        WebUI.setText(findTestObject('Object Repository/Page_Spectrum community/input_Info_sc-gzVnrw lbskuL'), 'Case 2')

        break
    default:
        WebUI.setText(findTestObject('Object Repository/Page_Spectrum community/input_Info_sc-gzVnrw lbskuL'), 'Default')

        break
}

WebUI.setText(findTestObject('Object Repository/Page_Spectrum community/textarea_pos'), 'New post')
