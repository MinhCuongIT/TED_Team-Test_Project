...
//Nếu chưa Join General thì Join vào
if (WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Spectrum community/button_Join_General'),25,FailureHandling.OPTIONAL) == true){
	
	WebUI.click(findTestObject('Object Repository/Page_Spectrum community/button_Join_General'))
	
	//Nếu thấy nút tắt thông báo thì bấm tắt
	if(WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Spectrum community/button_mute_ring'),25,FailureHandling.OPTIONAL) == true){
		
		WebUI.click(findTestObject('Object Repository/Page_Spectrum community/button_mute_ring'))
	...
	WebUI.comment("You was join in this channel!")
}
