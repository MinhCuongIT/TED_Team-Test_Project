...
if (WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Spectrum community/button_Join_Music'),25,FailureHandling.OPTIONAL) == true){
	WebUI.click(findTestObject('Object Repository/Page_Spectrum community/button_Join_Music'))
}
else{
	WebUI.comment("You was join in this chanel!")
}
