...
if (WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Spectrum community/button_Leave_Music'),25,FailureHandling.OPTIONAL) == true){
	WebUI.click(findTestObject('Object Repository/Page_Spectrum community/button_Leave_Music'))
}
else{
	WebUI.comment("You was not join in this chanel!")
}